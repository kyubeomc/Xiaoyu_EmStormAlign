function [sumim,sumimregi,allIm]= SuperResAlign3D(file,imsize,zoomfactor, pixelsize, photonpercount,angrange,angstep,rotrange,rotstep,n_iteration)
%% 3D Alignment  %   Xiaoyu Shi@Bo Huang Lab at UCSF
%% input
%   file is the name of the txt file of molecule list.     e.g. 'Cep164-3D'
...
[aligniter,sumimregi,s,allIm,data] = rotregistrationALL3D(images0,data0,angrange,angstep,n_iteration,rotrange,rotstep,imsize,zoomfactor, pixelsize, photonpercount);

%% write
writelist11(data,file);   % outputs an aligned molecule list
