function [allim2x,dataf3,dataf23,alignk] = rotregistration3D2C(buf1ft,dataf0,dataf02,angrange,angstep,rotrange,rotstep)
%% by Xiaoyu Shi @ Bo Huang Lab, UCSF
%%
usfac = 100;

imsize = size(buf1ft,1);
dataf2=dataf0;
dataf3=dataf0;
x0=dataf0(:,4);
y0=dataf0(:,5);
...
for l=1:(rotrange/rotstep+1)  % 3d rotation around x
    ...
    xyz(:,:,l) = [x1 y1 z1];
                ...
                x21 = x20;
                y21 = y20*cos(thetax) - z20*sin(thetax);
                z21 = y20*sin(thetax) + z20*cos(thetax);            
    ...
    [ im2 ] = NormalizedGaussian(dataf2,3,20,175, 0.41);
...
dataf3(:,18) = z2*175;
            ...
            y22 = xyz2(:,2,Ix);
            z22 = xyz2(:,3,Ix);
            x23 = x22*cos(Anglez/180*pi) - y22*sin(Anglez/180*pi)+ col_shiftx/20; 
            y23 = x22*sin(Anglez/180*pi) + y22*cos(Anglez/180*pi)+ row_shiftx/20;
            dataf23(:,4) = x23;
            dataf23(:,5) = y23;
            dataf23(:,18) = z22*175;
